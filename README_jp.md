...
include/
  ...
  rix/
    ...
    rix_hash32.h    カッコーハッシュ -- u32 キー版
    rix_hash64.h    カッコーハッシュ -- u64 キー版
...
| hash32  | `rix_hash32.h`       | `u32` キーをバケットに直接格納          | (なし)                      | 128 B (2 CL) | 32 ビット整数キー |
| hash64  | `rix_hash64.h`       | `u64` キーをバケットに直接格納          | (なし)                      | 192 B (3 CL) | 64 ビット整数キー |
