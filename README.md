...
| mrsw/mrmw | `rix_hash_mr.h`    | fp/keyonly/u32/u64/slot_extra, selected by generator | per-bucket `ctrl`; optional `hash_field`/`slot_field`; MRMW writer lock | 128 B or 192 B, 15 slots | Lockless readers with one or multiple writers |
