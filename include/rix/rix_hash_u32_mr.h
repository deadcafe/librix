...
/* U32 MRMW insert_slow.  See rix_hash_fp_mr.h for the algorithm description;
 * this is the U32 specialization (no fingerprint - bk->hash[] stores the full
 * u32 key, alt bucket comes from a rehash). */
#  define _RHM_MRMW_U32_INSERT_SLOW(name, type, key_field, attr)               \
