 ...
 *
 *   Hash Tables (rix/rix_hash.h, rix/rix_hash_u32.h, rix/rix_hash_u64.h)
 ...
 *     The MRSW variant keeps the same high-level API shape but uses a
 *     per-bucket atomic control word and SIMD hash-slot loads.
 *
 * -----------------------------------------------------------------------
 * Quick Start
 * -----------------------------------------------------------------------
