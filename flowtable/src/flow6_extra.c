...
RIX_HASH_GENERATE_SLOT_EXTRA_STATIC_EX(fcore_flow6_extra_ht, flow6_extra_entry,
...
RIX_HASH_GENERATE_SLOT_EXTRA_STATIC_EX(ft_flow6_extra_ht, flow6_extra_entry,
