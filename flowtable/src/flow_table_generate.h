 ...
 * All rights reserved.
 *
 * flow_table_generate.h - GENERATE macro for per-variant table implementations.
 *
 * Usage in .c files:
 *
...
#ifndef _FLOW_TABLE_GENERATE_H_
#define _FLOW_TABLE_GENERATE_H_
...
/*===========================================================================
 * FT_TABLE_GENERATE(prefix, hash_fn, cmp_fn)
 *
 * Bulk operations delegate to the FCORE_GENERATE functions (_fcore_<p>_*).
 *===========================================================================*/
#define FT_TABLE_GENERATE(p, hash_fn, cmp_fn)                                 \
                                                                               \
/* --- Internal helpers -------------------------------------------------- */ \
                                                                               \
